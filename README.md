...
## 核心能力
- **滑雪后台模式**：前台磁力监听服务在息屏时保持高采样，并通过唤醒锁和心跳看门狗尽量维持后台响应。
- **磁力动作识别**：自动归零、动态调节采样率，检测磁场强度/极性变化，抑制长时间强磁贴合误触发。
...
3. 如需最大化后台稳定性，在系统无障碍设置开启 **MagnetController 后台辅助服务**。
...
| 选项 | 作用 | 默认 |
| --- | --- | --- |
| 滑雪后台模式 | 息屏时保持高采样、持有 CPU 唤醒锁，并用心跳看门狗重启传感器监听 | 开启 |
